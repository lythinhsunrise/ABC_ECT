			...
			<div id="content-tk">
					...
					<center>Quản Lý Tài Khoản</center>
									...
									case 'Search':
										{
											...
											elseif($o->timkiem("select * from nv where nv.sdt='$id_sdt'")==1)
											{

											}
											elseif($o->timkiem("select * from ql where ql.sdt='$id_sdt'")==1)
											{
						...
						<table id="taotk">
								...
								<?php
									$o->xuatdstaikhoan("select * from ql");
									$o->xuatdstaikhoan("select * from nv");
