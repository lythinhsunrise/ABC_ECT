...
<html>
    <head>
        ...
        <link href="../css/kt.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <div id="left">
        ...
        <div id="right">
            ...
            <div id="content-right">
                <div id="content">
                        <div id="class" style="border-bottom: none;">
                            <div id="content-class">
                                Tạo bài kiểm tra cho các lớp hiện đang giảng dạy :
                            </div>
                            <div id="buttom-class">
                                <a href="../GV/GV_kt_nghe.php" style="width: 15%;"><button style="width: 45%;">Listening</button></a>
                                <a href="../GV/GV_kt_doc.php" style="width: 15%;"><button style="width: 45%;">Reading</button></a>
                            </div>
                        </div>
                </div>
            </div>
