							...
							<form id="taotk" method="post">
								<table id="taotk">
									...
									<tr>
										...
										<td>
											<input type="text" id="name" name="name" style="float:right" placeholder="Họ Tên.." required>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											...
											required oninvalid="this.setCustomValidity('SDT bao gồm 10 chữ số và bắt đầu bằng 0')"
									...
									<tr>
										...
										<td>
											<input type="text" id="pass" name="pass"placeholder="Pass.."  style="float:right" required>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" id="mail" name="mail"placeholder="Email.." style="float:right">
										</td>
									</tr>
									<tr>
										<td>
