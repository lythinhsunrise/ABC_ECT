...
{
	if($_SESSION['quyen'] == 2 || $_SESSION['quyen'] == 3)
	{
                    ...
                    <div class="top-right">
                            ...
                            <h3><?php
                                ...
                                if($_SESSION['quyen']==2)
                                {
                                    ...
                                    echo $p->laycot("select Name from gv where gv.SDT=$sdt");
                                    $nameuser= $p->laycot("select Name from gv where gv.SDT=$sdt");
                                    
                                }
                                if($_SESSION['quyen']==3)
                                {
                                    
                                    echo $p->laycot("select Name from hv where hv.SDT=$sdt");
                                    $nameuser= $p->laycot("select Name from hv where hv.SDT=$sdt");
                                ...
                                if($_SESSION['quyen']==2)
                                {
                                    echo "<a href='../../GV/index.php'>Quay lại</a>";
                                }
                                if($_SESSION['quyen']==3)
                                {
                                    echo "<a href='../../HV/index.php'>Quay lại</a>";
                                }
                                ?>
