        ...
        <div id="content-right">
            <div id="content">
				<div id="test" style="color: black;">
					<p>Listening<a href="../HV/HV_kt_class_lis.php"><input type="button" value="làm bài"></a></p>
                    <p>Reading<a href="../HV/HV_kt_class_rea.php"><input type="button" value="làm bài"></a></p>
				</div>
            </div>
        </div>
        </div>
